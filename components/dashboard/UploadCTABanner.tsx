...
export default function UploadCTABanner() {
  return (
    <div className="glass-card p-8 sm:p-10 mb-10 relative overflow-hidden noise">
      ...
      <div className="absolute -top-20 right-0 w-96 h-96 bg-[radial-gradient(circle,rgba(57,255,20,0.16),transparent_60%)]" />
      <div className="relative grid md:grid-cols-[1fr_auto] gap-6 items-center">
        <div>
          <p className="eyebrow mb-2">Nothing here yet</p>
          <h2 className="text-2xl sm:text-3xl font-bold">Upload your raw DNA file to unlock 40 traits</h2>
