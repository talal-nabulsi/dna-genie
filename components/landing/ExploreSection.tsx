...
export default function ExploreSection() {
  return (
    <section id="explore" className="py-24 sm:py-32 px-5 sm:px-8 scroll-mt-16 relative">
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[600px] bg-[radial-gradient(ellipse_at_center,rgba(57,255,20,0.07),transparent_60%)] pointer-events-none" />
      <div className="relative max-w-7xl mx-auto">
        <Reveal className="max-w-2xl mb-10">
          <p className="eyebrow mb-3">Interactive</p>
          <h2 className="text-3xl sm:text-5xl font-bold">Walk the helix.</h2>
