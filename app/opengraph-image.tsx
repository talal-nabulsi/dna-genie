  ...
  return (
    <svg width="520" height="560" viewBox="0 0 520 560" fill="none">
      ...
      {rungs.map((i) => {
        ...
        const colors = ["#22e3a0", "#19d4c6", "#b6f542", "#3ab8ff"];
        return (
          <g key={i}>
            <line x1={x1} y1={y} x2={x2} y2={y} stroke={colors[i % 4]} strokeWidth="10" strokeLinecap="round" opacity="0.9" />
            <circle cx={x1} cy={y} r="13" fill="#e6f4e8" />
            <circle cx={x2} cy={y} r="13" fill="#e6f4e8" />
          </g>
        );
      })}
    ...
    (
      <div
        style={{
          ...
          height: "100%",
          display: "flex",
          background: "radial-gradient(ellipse at 75% 50%, rgba(57,255,20,0.18), #060907 60%)",
          color: "#eef5ee",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, fontSize: 26, fontWeight: 700, marginBottom: 36 }}>
            <div style={{ width: 14, height: 14, borderRadius: 999, background: "#39ff14", boxShadow: "0 0 18px #39ff14" }} />
            DNA Genie
          </div>
          <div style={{ fontSize: 68, fontWeight: 800, lineHeight: 1.02, letterSpacing: -2, display: "flex", flexDirection: "column" }}>
            ...
            <span style={{ color: "#39ff14" }}>decoded</span>
            <span>in the browser.</span>
          </div>
          <div style={{ fontSize: 24, color: "#8aa38d", marginTop: 28, lineHeight: 1.4 }}>
